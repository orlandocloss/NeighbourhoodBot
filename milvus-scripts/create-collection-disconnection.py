# create-collection-disconnection.py
...
utility.drop_collection("disconnection")

# Define the disconnection_id field
disconnection_id = FieldSchema(
  name="disconnection_id",
...
schema = CollectionSchema(
  fields=[disconnection_id, embeddings, text],
  description="Collection for storing disconnection data and their embeddings for similarity search"
)

# Collection name
collection_name = "disconnection"
...
create_index_for_collection("disconnection")
